...
const YCalendar = ({ tasks, onTaskUpdated }) => {
    ...
    const tasksForYear = (0, react_1.useMemo)(() => {
        ...
        const isBottom = (t) => {
            ...
            const isOverdue = !isDone && new Date(`${t.endDate}T${t.endTime || '23:59'}`).getTime() <= Date.now();
    ...
    return ((0, jsx_runtime_1.jsxs)("div", { style: { padding: '28px 32px', background: '#F9FAFB', minHeight: '100vh' }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '24px' }, children: [(0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)("h1", { style: { margin: 0, fontSize: '22px', fontWeight: 700, color: '#111827', display: 'flex', alignItems: 'center', gap: '8px' }, children: [(0, jsx_runtime_1.jsxs)("svg", { width: "22", height: "22", viewBox: "0 0 24 24", fill: "none", stroke: "#5B5CEB", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [(0, jsx_runtime_1.jsx)("rect", { x: "3", y: "4", width: "18", height: "18", rx: "2" }), (0, jsx_runtime_1.jsx)("line", { x1: "16", y1: "2", x2: "16", y2: "6" }), (0, jsx_runtime_1.jsx)("line", { x1: "8", y1: "2", x2: "8", y2: "6" }), (0, jsx_runtime_1.jsx)("line", { x1: "3", y1: "10", x2: "21", y2: "10" })] }), "L\u1ECBch N\u0103m", (0, jsx_runtime_1.jsxs)("span", { style: {
                                    ...
                                    fontWeight: 500, fontSize: '13px', cursor: 'pointer',
                                            ...
                                            : (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)("polyline", { points: "9 11 12 14 22 4" }), (0, jsx_runtime_1.jsx)("path", { d: "M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11" })] }) }), selectionMode ? 'Huỷ chọn' : 'Xóa hàng loạt'] }), (0, jsx_runtime_1.jsxs)("div", { style: { position: 'relative', display: 'flex', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsx)("select", { value: selectedYear, onChange: e => setSelectedYear(Number(e.target.value)), style: {
                                        ...
                                        }, children: years.map(y => (0, jsx_runtime_1.jsx)("option", { value: y, children: y }, y)) }), (0, jsx_runtime_1.jsx)("svg", { style: { position: 'absolute', right: '10px', pointerEvents: 'none' }, width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "#6B7280", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: (0, jsx_runtime_1.jsx)("polyline", { points: "6 9 12 15 18 9" }) })] })] })] }), (0, jsx_runtime_1.jsx)(SumaryBox_1.default, { tasks: tasksForYear }), (0, jsx_runtime_1.jsxs)("div", { style: {
                    background: '#FFFFFF', borderRadius: '12px', padding: '20px 24px',
                    border: '1px solid #E5E7EB', marginBottom: '20px'
                }, children: [(0, jsx_runtime_1.jsxs)("div", { style: { fontSize: '13px', fontWeight: 600, color: '#374151', marginBottom: '14px', display: 'flex', alignItems: 'center', gap: '6px' }, children: [(0, jsx_runtime_1.jsxs)("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "#5B5CEB", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", children: [(0, jsx_runtime_1.jsx)("line", { x1: "18", y1: "20", x2: "18", y2: "10" }), (0, jsx_runtime_1.jsx)("line", { x1: "12", y1: "20", x2: "12", y2: "4" }), (0, jsx_runtime_1.jsx)("line", { x1: "6", y1: "20", x2: "6", y2: "14" }), (0, jsx_runtime_1.jsx)("line", { x1: "2", y1: "20", x2: "22", y2: "20" })] }), "Ph\u00E2n b\u1ED1 theo th\u00E1ng"] }), (0, jsx_runtime_1.jsx)("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(12,1fr)', gap: '8px', alignItems: 'flex-end' }, children: monthStats.map((count, i) => ((0, jsx_runtime_1.jsxs)("div", { style: { textAlign: 'center' }, children: [(0, jsx_runtime_1.jsx)("div", { style: { fontSize: '12px', fontWeight: 600, color: count > 0 ? '#5B5CEB' : '#D1D5DB', marginBottom: '4px' }, children: count }), (0, jsx_runtime_1.jsx)("div", { style: {
                                        height: `${Math.max(6, (count / maxMonth) * 48)}px`,
                                        background: count > 0 ? 'linear-gradient(180deg,#818CF8,#5B5CEB)' : '#F3F4F6',
                                        borderRadius: '4px 4px 0 0',
                                        transition: 'height 0.3s',
                                    } }), (0, jsx_runtime_1.jsx)("div", { style: { fontSize: '11px', color: '#9CA3AF', marginTop: '4px', fontWeight: 500 }, children: MONTHS[i] })] }, i))) })] }), selectionMode && ((0, jsx_runtime_1.jsx)(BulDeleteBar_1.default, { count: selectedIds.length, onDelete: handleBulkDelete, onCancel: () => { setSelectionMode(false); setSelectedIds([]); } })), (0, jsx_runtime_1.jsxs)("div", { style: { background: '#FFFFFF', borderRadius: '12px', border: '1px solid #E5E7EB', overflow: 'hidden' }, children: [(0, jsx_runtime_1.jsx)("div", { style: {
                            display: 'grid',
                            gridTemplateColumns: gridCols,
                            background: '#F9FAFB',
                            borderBottom: '1px solid #E5E7EB',
                            padding: '0',
                        }, children: COLS.map(col => ((0, jsx_runtime_1.jsx)("div", { style: {
